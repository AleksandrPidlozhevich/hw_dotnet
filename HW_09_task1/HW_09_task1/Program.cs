...
namespace HW_09_task1
{
    class Program
    {
        ...
        static void Passport_Check()
        {
            ...
            Console.Write(p.SecondName + " " + p.FirstName + "\n" + message.passportCheckMessage + p.PassportNam + "\nверно?");
            ...
            while (!str.Equals("да"))
            {
                ...
                p.PassportNam = Console.ReadLine();
                Passport_Check();
            }
        ...
        static void CheckIn_Method()
        {
            ...
            for (p.PassportNam = Console.ReadLine(); p.PassportNam.Length <= 0; p.PassportNam = Console.ReadLine())
            {
                Console.WriteLine(message.chechInFail);
            }
